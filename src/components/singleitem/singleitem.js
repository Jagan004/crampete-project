...
import ControlledTabsExample from "../tabs/tabs";
...
function SingleItem() {
    ...
    const [id, setId] = useState(null)// identy="2"
    // const [name, setName] = useState(null)// name="mens"
...
// }
    ...
    return (
        <>
            <NavScrollExample product={product}/>
            <div className="row singleItem-sep">
                <div className="col-lg-6 col-sm-12 singleItem-img">
                <img
                ...
                <div className="col-lg-6 col-sm-12">
                    <h2>Product name :</h2>
                    <p>{Boolean(product) && product.productName}</p>
                    <h2>description :</h2>
                    <p>{Boolean(product) && product.description}</p>
                    <h2>${Boolean(product) && product.Price}</h2>
                    <div>
                        <button>Buy</button>
            ...
            <ControlledTabsExample specification={Boolean(product) && product.title} />
        </>
    )
}
